...
})) //  a todo le pone * (SI) pero hay manera de controlarlo
...
/*
* Esto lo copiamos y lo llevamos a dodne estamos usando cors ya que aqui ya no estamos haciendo de manera controlada
const ACCEPED_ORIGINS = [
  'http://localhost:8080',
  'http://localhost:1234',
  'https://movies.com',
...
app.get('/movies', (req, res) => {
  /*
  * Con el middleware evitamos usar esto
...
app.delete('/movies/:id', (req, res) => {
  /*
  * Con middleware cors evitamos hacer esto
  const origin = req.header('origin')
...
/*
* Usando el middleware de cors evitamos hacer esto
